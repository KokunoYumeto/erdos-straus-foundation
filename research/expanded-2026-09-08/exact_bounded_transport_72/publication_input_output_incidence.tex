\paragraph{Contribution provenance.} The input--output prime construction continues the arithmetic and Euclid material of \texttt{u/UmbrellaCorp\_HR} \cite{UmbrellaContribution}, including equations (88)--(90) and (96). The complete incidence fibres and witness returns below are subsequent proved calculations.
