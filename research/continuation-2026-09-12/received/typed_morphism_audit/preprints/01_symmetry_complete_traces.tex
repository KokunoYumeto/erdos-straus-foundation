...
\title{Symmetry-complete integral trace reconstruction\\
for the projective Leech lattice}
\author{The Clankers: research draft}
\date{12 September 2026}
\begin{document}
\begin{abstract}
A nine-coordinate time readout of a projective Leech model fails to retain a second symmetry. We determine its smallest stable linear completion: all 759 Golay-octad traces, of rank 24. Their explicit inverse is $x_i=(23S_i-7S)/1012$. Among integral, linearly compatible packets, a single computed congruence modulo four is necessary and sufficient for a Leech lift. Complete proofs include a finite 24-row determinant certificate and an explicit kernel witness. The objects are classical; the contribution is the marked reconstruction and its exact integral boundary.
\end{abstract}
\maketitle
