...
\begin{figure}[ht]
\centering
\input{figures/affine_channel_operator.tex}
...
\begin{figure}[ht]
\centering
\input{figures/mixed_radix_chain.tex}
...
Infinitely many prime members satisfy $p>R$ and therefore have
$a=(p+R)/4=AH$ with
...
exact empty specified subpacket while retaining every other original word in
the complete shell outside that subpacket.
...
\begin{figure}[ht]
\centering
\input{figures/plus_factor_fibre.tex}
