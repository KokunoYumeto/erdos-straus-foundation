...
\title[Prime-local Fabel fibres and channel transfer]{Three local inverse points, two ramification types,\newline and an original Erd\H{o}s--Straus channel transfer}
...
middle state. Universal existence is not asserted.
\end{abstract}
\maketitle
...
\]
In particular both entire lines $\alpha=-4$ and $\beta=-4$ have middle returns.
\end{theorem}
\begin{proof}
The shape congruences make $h$ odd and coprime to $c$. Reciprocity gives
$(h/p)=(-1/h)=-1$, hence $h=4j-1$. In the first case $h\mid p+4c^2$.
...
$(a,R,u,h,r,s,\kappa)=(1330,111,18620,95,14,1,657)$ has shape
$(-16,-576)$. Its two marked returns ($c=2$ on $\alpha$, $c=12$ on $\beta$)
coincide at $j=24,U=4$. The M state is $(a_M,R_M,u_M,h_M,r_M,s_M,\lambda_M)
=(1316,55,4,4,1,329,6)$, giving
\[
