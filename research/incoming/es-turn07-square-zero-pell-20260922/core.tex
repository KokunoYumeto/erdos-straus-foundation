...
Every positive rational tail pair at this integral $a$ with integral sum
occurs in these coordinates, with the E swap retained.
\end{lemma}
\begin{proof}
...
\input{figures/factor_sum_geometry.tex}
