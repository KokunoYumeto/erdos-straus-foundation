...
def solve_r27(p: int) -> dict[str, Any]:
    ...
    result['construction'] = {'reason': reason, 'centred_exponents': sorted(beta.items())}
...
def examples() -> list[dict[str, Any]]:
    ...
    e = solve_r27(6841)
    require(e['ordered_denominators'] == [1717, 436118, 175499014], 'known E control')
    m = third_defect_return(6121, 27, 29)
    require(m['channel'] == 'M' and m['ordered_denominators'][0] == 1537, 'M control')
    a = solve_r27(1009)
    b = solve_r27(73)
