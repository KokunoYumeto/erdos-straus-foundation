...
**Type II:** \(x=p^rX,y=p^rY,z=Z\), where \(r\ge1\) and \(X,Y,Z\) are units. To prove equality of the two valuations, suppose they are \(a<b\). Then the two sides of the cleared equation have valuations \(a+1\) and \(a+b\), implying \(b=1\), contrary to \(1\le a<b\).
...
For \(r=1\), substitution in E1 yields
\[
\frac{N}{p^2}\equiv
...
For \(r\ge2\), \(S\equiv Z\), \(e_2/p\equiv Z\), \(v_p(e_3)\ge4\), and \(v_p(e_4)\ge5\). Reading E1 shows directly that its unique contribution of order two is
\[
\frac{N}{p^2}\equiv-20Z^6\not\equiv0\pmod p.
\tag{E5}
\]
The exceptional primes dividing these displayed constants are excluded by the character conditions below.
...
Split-Zero programme. (2026b, September 20). *Original arithmetic spectral action and metric curvature* [Research source edition]. Zeta-function research reader, commit `4594c6d7528472bb2c7998ced3a7db5d7ac72bd5`. NATIVE_SPECTRAL_ACTION.tex and RANK_ONE_METRIC_CURVATURE.tex; point-of-use SA/MC locators and reading boundary in SOURCE_LEDGER.md.
