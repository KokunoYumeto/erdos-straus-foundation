...
\title[Small-shape certificates and middle returns]{Small-shape exterior certificates force original middle states\newline in the Erd\H{o}s--Straus equation}
...
Its Weierstrass discriminant is $16B^2((\alpha-\beta)^2+4)$.
...
The original fibre retains positive odd $t$, reconstructing
...
\]
Any such hard candidate satisfies $p\bmod840\in\{1,121\}$.
...
Modulo five the quartic and the hard residue condition give $p\equiv1\pmod5$.
Modulo seven it gives $r^2\equiv s^4-s^2+1$; the square classes leave only
$p\equiv1,2\pmod7$. Together with $p\equiv1\pmod{24}$ this gives the two
stated classes modulo 840.
Now (1) gives $p\equiv8\pmod{11}$. Thus $s_M$ is integral and
$p=11s_M-3=12s_M-(3+s_M)$. Primality gives $\gcd(3,s_M)=1$; the source range
follows from $s_M\equiv4\pmod8$, and the ordered M identity follows by direct
substitution. Solving the quartic is
...
priority, independent human mathematical review or Lean build is claimed.
