...
\begin{theorem}[Exact shape curve and inverse]\label{thm:curve}
...
$B^2((\alpha+\beta)^2-4B)$. Multiplication by 16 gives (7).
...
Its complete fibre above a marked (10) retains the odd integer $t$, with
\[
...
\]
and the complementary orientation. The new ordered denominator triple is
...
from $s_M>3$, and substitution proves both the original M gate and its ordered
...
\[
 h'=4r^2+h-R-D,\quad R'=4r^2-D,\quad D'=4r^2-R,
 \quad a'=rh',\quad p'=4rh'-R'.                          \tag{20}
\]
...
At $p=2129$, its positive numerical image has $p'=5951$, $R'=D'=249$,
...
inverse for the hard-prime problem. This does not prohibit the other
$p'\equiv3\pmod4$ sources, such as the displayed numerical image at 5951;
it identifies why the immediate reverse construction is insufficient.
...
execution runner. No independent mathematical review or Lean build is claimed.
