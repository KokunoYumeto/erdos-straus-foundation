...
| Global traces and raw-source fibres | For $n\ge3$ rational denominators with reciprocal sum $4/p$, integrality of the first $n-1$ power sums is equivalent to integrality of every denominator; for ES, two traces suffice. On the complete raw integer gate, a single integral literal trace recovers the original divisor budget and E/M tag, with two-point fibres exactly $U\leftrightarrow a^2/U$ in the middle channel and kernel basis $e_U-e_{a^2/U}$. [Proof, figure and replays](research/incoming/es-turn07-trace-rigidity-20260920/README.md). | The theorem tests a supplied raw word; it does not force an integral trace to occur at every hard prime. The unresolved statement remains positive occupancy of the integral trace image, equivalently an original divisor hit. |
| Original-divisor trace descent | For a trace source with common reduced denominator $d=R/\gcd(R,G_c)$ and word modulus $m=4K(u)$, every positive same-word residual-divisor return is exactly $k\mid R$, $d\mid k$, $k\equiv1\pmod m$, with $R'=R/k$ and $a'=(p+R')/4$. The global domain is the decorated-arrow set; full target fibres, kernel differences and a right inverse are explicit. A universal strict return exists exactly for the nine words $u\mid36$, while every other fixed word has infinitely many proper M sources with no such return, including its middle complement. [Proof, audits, figures and replays](research/incoming/es-turn07-divisor-descent-20260921/README.md). | The obstruction is exact for this transformation system and is not an ES counterexample. A universal proof still has to force a suitable initial trace source, change the word beyond the proved complement, or construct a rigorously typed non-divisor residual arrow. |
| Global sign of the literal odd receiver | For every positive integral ES witness at every prime $p\equiv1\pmod {12}$, the original signed receiver numerator obeys $\mathfrak N<-(125873811/262144)p^8$. The stronger mod-$24$ constant is $327448292668/47045881$. The original determinant phase is retained, $|\det O|>4cp^8/S^3$, and the standard-Hermitian inverse satisfies $\|O^{-1}\|_2<360S^9/(cp^8)$. [Pinned theorem, arithmetic reduction, certificates and inverse](https://github.com/KokunoYumeto/erdos-straus-foundation/blob/6bdfce25724b95a4b30e97f0df69879a87793302/research/incoming/es-turn07-global-receiver-determinant-20260921/core.tex#L1-L424). | This removes the receiver singularity from every existing integral witness, not the initial occupancy problem. A proved positive-real reciprocal family has one collision-free receiver singularity outside the integral E/M domains. |
| Sharp receiver conditioning and exact defect | On every existing integral hard-prime witness, $\|O^{-1}\|_2<360p\sqrt w/\gamma$, $\|\wedge^2O^{-1}\|_2<180/\gamma$, and $\|\wedge^3O^{-1}\|_2<41/(4\gamma p^2)$ for $\gamma=80/6279^4$. Hence $s_3(O)>\sqrt{\gamma/180}$ and at most one inverse singular direction can diverge. Two $p\equiv13\pmod {24}$ witness families attain the three exponents. In the enlarged space of four distinct positive labelled roots, the exact divisor $\mathfrak h=0$ has receiver rank three with an explicit kernel and cokernel hyperplane; the global sign theorem proves that this divisor is disjoint from the positive integral witness locus. [Pinned theorem, families and transport](https://github.com/KokunoYumeto/erdos-straus-foundation/blob/e713c342fc16e361e104de3322790ca0cee7281d/research/incoming/es-turn07-sharp-receiver-growth-20260921/core.tex#L75-L636). | The result begins with an integral witness. Its sharpness families lie in the class $13\bmod24$, so they do not settle the optimal constants on the image of the later mod-$24$ trace-return map. |
| Modulo-24 mixed trace return and receiver composite | Let $p\equiv1\pmod {24}$ be prime and $a=cq$ with $c\mid6$, $q>3$ prime, $p/4<a<p/2$. Every positive rational ES tail pair at $a$ with integral sum is carried to an original integral middle witness at the same $p$. The exterior branch preserves the primitive ray exactly when $k\mid R$, $d\mid k$ and $k\equiv1\pmod{4rs}$; all such sources return automatically on exactly the nine ordered rays with $rs\mid6$. The returned witness maps into the literal receiver with explicit branch coordinates, fibres, determinant and compound-inverse bounds. [Pinned theorem and source-changing formulas](https://github.com/KokunoYumeto/erdos-straus-foundation/blob/e713c342fc16e361e104de3322790ca0cee7281d/research/incoming/es-turn07-mod24-ray-trace-20260922/core.tex#L9-L322); [typed receiver composite](https://github.com/KokunoYumeto/erdos-straus-foundation/blob/687d16739a10788b6f1b079d0c079cc68cbfc5f7/research/incoming/es-turn07-mod24-ray-trace-20260922/receiver_bridge.tex#L7-L280). | The domain still assumes the rational trace source. For every ray outside $rs\mid6$, an infinite reduced progression obstructs the universal ray-preserving residual-divisor rule, but separately constructed middle witnesses show that this is a method obstruction rather than an ES counterexample. |
| Complete mixed-return fibres and hard-middle spectra | For any supplied sorted middle target, the full ordered mixed-source fibre is the disjoint E/M union indexed by the exact divisor sets $\mathcal I_E(W)$ and $\mathcal I_{M,\nu}(W)$, with size $2|\mathcal I_E|+2\sum_\nu|\mathcal I_{M,\nu}|$. The full labelled receiver matrix and $p$ reconstruct the returned target and its four selected square-root branches, not a unique source in that fibre. A fixed-positive-$(R,u)$ family has singular powers $9,4,3/2,-3/2$, complete first corrections and observation powers $0,2,3,9$. Two reduced progressions in $1\bmod840$ attain the inherited inverse powers $p^{3/2},1,p^{-2}$. [Pinned complete proofs and certificates](https://github.com/KokunoYumeto/erdos-straus-foundation/blob/687d16739a10788b6f1b079d0c079cc68cbfc5f7/research/incoming/es-turn07-fibres-middle-spectrum-20260922/core.tex#L74-L641). | A fibre may be empty, and neither the receiver inverse nor the prime progressions prove a mixed source at every target or a witness at every hard prime. Sharpness on the smaller mixed-return image is not asserted. |
| General-family source geometry and ES-labelled tensor action | The mixed source has exact minimum $G_J=G^{1/2}(I+T)^{-1}G^{1/2}$, with a complete kernel/observation determinant split and certified regularized range inverse. The ES-labelled action has an exact common reducing space, a tridiagonal adjoint-leakage Gram containing the centre--length covariance, and full-multiplicity dimension and leakage-rank formulas. Every two-centre collision singular exponent is evaluated in the regimes $a\le1$ and $a\ge1$. [Proof, figures and replay](research/incoming/es-rh-family-integration-c-20260920/README.md). | The original native cross Gram and moments remain inputs. The metric asymptotics depend on pinned NG20--NG21 for a stipulated quartet; no off-line zero or RH conclusion is asserted. The labelled action starts from an ES witness and does not force occupancy at a prescribed hard prime. |
| Square-zero trace defects and source-changing fibres | The original E/M trace boxes admit an exact square-zero fine coordinate. Its complete bounded coefficient partition, prime-power classification, factor-sum map and fixed-tail-sum map retain every original word and gate. The factor-sum map has a Pell specialization; the fixed-sum map has an exact divisor/discriminant inverse. [Complete proofs](https://github.com/KokunoYumeto/erdos-straus-foundation/blob/6c064a07298cdba38352998364ce6b7cb3efa973/research/incoming/es-turn07-square-zero-pell-20260922/core.tex#L33-L989). | Prime-square traces are terminal for the two inherited deletion systems, and no same-tail-sum target can return to a proper residual divisor. The least $p=67369$ prefix refutes universal nonincreasing-$a$ repair. These are map-specific obstructions, not an ES counterexample; a source-changing map may increase $a$ or change the retained tail sum. |
| Affine channel operator and mixed-order quotient descent | On the common-trace locus, $c_E=c_M-(p-1)/K$ in $\mathbb Z/D$, and the labelled two-channel vector is $(I+T_\omega)C$. Since $D$ is odd, this map is injective with an alternating inverse and orbit-parity cokernel. A partial mixed-order chain gives $C_x=BQ_{x\bmod g}+E_x$ and reduces paired positivity exactly to $\operatorname{supp}(Q)\cup(\operatorname{supp}(Q)+\delta)=\mathbb Z/g$. [Affine and quotient proofs](https://github.com/KokunoYumeto/erdos-straus-foundation/blob/6125e74b1aadb860965964e2ae3587c902dbbab8/research/incoming/es-turn07-mixed-order-upward-20260923/core.tex#L101-L395). | Pairing the two channels is not an averaging proof: it loses no rational coefficient information, and its inverse has alternating signs. If the residual steps lie in a proper subgroup, two channel labels cannot close the missing quotient. The current structural obligation is an actual quotient-support cover or another exact source-changing morphism, not a larger census. |
| Signed opposition form, cross-shell boundary, and odd-quotient colours | For every original shell and real $\sigma$, the complete divisor source satisfies $\mathcal T_{p,a}(\sigma)=2\sum_{u\in E_a}W_\sigma(h_u)+(p^\sigma+p^{-\sigma})\sum_{u\in M_a}W_\sigma(h_u)$, so positivity is equivalent to E/M occupancy. Its character formula retains $\chi(-1)$ and its parity form is $\|P_+v\|^2-\|P_-v\|^2$. Across shells $a$ and $a+mR$, an opposed pair gives $\lambda\beta-d\mu=e\mu-\lambda\alpha=pm$ and $4/p=1/a+1/(\lambda\alpha)+1/(\mu d)+m/(a\lambda\mu)$. The first and fourth terms fuse exactly when $\nu\mid a$; otherwise their cyclic boundary class has order $\rho=\nu/\gcd(a,\nu)$. For $m=\gcd(R,p-1)$, $R\mid m^2$, and $N=R/m$, complementation sends $b_u=(p+4u)/m$ to $-b_u$ and gives $|\mathcal T_N|=2|E_a|+|M_a|+|U_N|$. [Complete proof](https://github.com/KokunoYumeto/erdos-straus-foundation/blob/13cdd6c8d1236b078bb503af698d132017ed99d7/research/incoming/es-third-defect-signed-pairing-20260923/core.tex#L45-L729). | $N=3$ is the unique nontrivial odd quotient for which complementation closes every possible colour orbit; explicit reduced prime progressions realize uncovered orbits for every odd $N>3$. At $N=3$, nonempty $\mathcal T_3$ returns to an original word and $2|E_a|+|M_a|=|\mathcal T_3|$, but the theorem does not force $\mathcal T_3\ne\varnothing$ for every hard prime. The complete $R=27$ empty-locus theorem is restricted to $p\equiv73$ or $145\pmod {216}$. The alternative global route must produce a cross-shell pair whose boundary class vanishes. |
...
The [23 September signed-pairing continuation](research/incoming/es-third-defect-signed-pairing-20260923/README.md)
extends the JT Boolean-pair antecedent to the complete weighted fibres, proves
the exact relation to the affine fine coordinate, and keeps the received
third-denominator proof and constructor byte-identical under `received/`.
The active constructor corrects two output labels: it separates the marked
denominator tuple from its increasing rearrangement and records both input and
output centred exponents after complementation. These schema repairs do not
alter the received files or enlarge the theorem's domain. The exact remaining
statement is source existence: every prescribed hard prime must supply a
nonempty applicable \(\mathcal T_3\), or a cross-shell pair with zero cyclic
boundary class, or another proved original-channel return.
