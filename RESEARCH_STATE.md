...
| Modulo-24 mixed trace return and receiver composite | Let $p\equiv1\pmod {24}$ be prime and $a=cq$ with $c\mid6$, $q>3$ prime, $p/4<a<p/2$. Every positive rational ES tail pair at $a$ with integral sum is carried to an original integral middle witness at the same $p$. The exterior branch preserves the primitive ray exactly when $k\mid R$, $d\mid k$ and $k\equiv1\pmod{4rs}$; all such sources return automatically on exactly the nine ordered rays with $rs\mid6$. The returned witness maps into the literal receiver with explicit branch coordinates, fibres, determinant and compound-inverse bounds. [Pinned theorem and source-changing formulas](https://github.com/KokunoYumeto/erdos-straus-foundation/blob/e713c342fc16e361e104de3322790ca0cee7281d/research/incoming/es-turn07-mod24-ray-trace-20260922/core.tex#L9-L322); [typed receiver composite](https://github.com/KokunoYumeto/erdos-straus-foundation/blob/e713c342fc16e361e104de3322790ca0cee7281d/research/incoming/es-turn07-mod24-ray-trace-20260922/receiver_bridge.tex#L47-L216). | The domain still assumes the rational trace source. For every ray outside $rs\mid6$, an infinite reduced progression obstructs the universal ray-preserving residual-divisor rule, but separately constructed middle witnesses show that this is a method obstruction rather than an ES counterexample. |
